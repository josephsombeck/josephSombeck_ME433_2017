...
void APP_Tasks(void) {
    ...
    switch (appData.state) {
        ...
        case APP_STATE_MOUSE_EMULATE:
            ...
            // every loop, or 1000 times per second
            ...
            if(inc == MAXINC){
                ...
                short accelX = (dataRaw[9]<<8 | dataRaw[8]);
                short accelY = (dataRaw[11]<<8 | dataRaw[10]);
                
                appData.xCoordinate = (int8_t) (accelX/1000);
                appData.yCoordinate = (int8_t) (accelY/1000);
                inc = 0;
            }
            else{
                inc++;
